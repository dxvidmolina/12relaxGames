...
CREATE TABLE `productos` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `productos_FK` FOREIGN KEY (`id`) REFERENCES `usuarios` (`id`)
...
CREATE TABLE `usuarios` (
  ...
  `Usuario_país` varchar(20) NOT NULL,
  `Usuario_mail` text NOT NULL,
  `Usuario_edad` int(11) NOT NULL,
  `Productos_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `usuarios_FK` FOREIGN KEY (`id`) REFERENCES `productos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
